...
Route::middleware(['logged'])->group(function () {
    ...
    Route::get('users/', [UserController::class, 'getAll'])->name('users.index');
    Route::post('users/', [UserController::class, 'store'])->name('users.store');
    Route::get('/users/{$id}', [UserController::class, 'getSpecific'])->name('users.profile');
    Route::put('users/{$id}', [UserController::class, 'update'])->name('users.update');
    Route::delete('users/{$id}', [UserController::class, 'destroy'])->name('users.destroy');    

    Route::get('clients/', [ClientsController::class, 'getAll'])->name('clientes.index');
    Route::post('clients/', [ClientsController::class, 'store'])->name('clientes.store');
    Route::get('/clients/{$id}', [ClientsController::class, 'getSpecific'])->name('clientes.detailClient');
    Route::put('clients/{$id}', [ClientsController::class, 'update'])->name('clientes.update');
    Route::delate('clients/{$id}', [ClientsController::class, 'destroy'])->name('clientes.destroy');

    Route::get('/catalogs/categories', [CategoriesController::class, 'getAll'])->name('catalogs.categories');
    ...
    Route::get('/catalogs/tags', [TagsController::class, 'getAll'])->name('catalogs.tags');
    ...
    // Route::delate('orders/{$id}', [ClientsController::class, 'destroy'])->name('orders.destroy');
    ...
    Route::get('coupons/', [CouponsController::class, 'getAll'])->name('coupons.index');
    Route::post('coupons/', [CouponsController::class, 'store'])->name('coupons.store');
    Route::get('/coupons/{$id}', [CouponsController::class, 'getSpecific'])->name('coupons.detailCoupon');
    Route::put('coupons/{$id}', [CouponsController::class, 'update'])->name('coupons.update');
    Route::delate('coupons/{$id}', [CouponsController::class, 'destroy'])->name('coupons.destroy');
});
