                                                                ...
                                                                <div class="row g-3">
                                                                    ...
                                                                    <div class="col-xxl-6">
                                                                        <div>
                                                                            ...
                                                                            <input type="text" name="name" class="form-control" id="firstName" placeholder="10% off" value="{{$coupon->name}}" onkeypress="return soloLetrasynumeros(event)" required>
                                                                        </div>
                                                                    </div>
                                                                    <!--end col-->
                            ...
                            <div class="d-flex align-items-center px-5 ms-xl-4">
                                ...
                                <div class="card card-animate bg-success" style="margin-left: 5%;">
                                    <div class="card-body">
                                        ...
                                        @foreach ($coupon->orders as $order)
                                            @php
                                                        $concat = $concat + (($order->total/ ((100-$coupon->percentage_discount)/100)) - $order->total);
                                                    @endphp
                                        @endforeach
                                        <div class="d-flex align-items-end justify-content-between mt-4">
                                            <div>
